...
if (!isset($_SESSION['info'])){header("location:"."../"."auth/");}
$userID = isset($_SESSION['info']['id']) ? $_SESSION['info']['id'] : null;
...
<head>
	...
	<!-- datepicker -->
	<script src="<?php echo $ASSETS_URL; ?>assets/js/angular-datepicker.js"></script>
	<link href="<?php echo $ASSETS_URL; ?>assets/css/angular-datepicker.css" rel="stylesheet" type="text/css">
	<!-- End datepicker -->
	<link href="<?php echo $ASSETS_URL; ?>assets/css/bootstrap4-toggle.min.css" rel="stylesheet">
	<script src="<?php echo $ASSETS_URL; ?>assets/js/bootstrap4-toggle.min.js"></script>
